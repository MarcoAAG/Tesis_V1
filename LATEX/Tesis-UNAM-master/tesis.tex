...
\facultad{Inovación educativa para el desarrollo de México}                 % Nombre de la facultad/escuela
...
\degree{Ingeniero en electrónica y control de sistemas de aeronaves}       % Carrera
\director{Antonio J. Flores}                   % Director de tesis
%\tutor{Nombre  Tutor }                    % Tutor de tesis, si aplica
\degreedate{2019}                                     % Año de la fecha del examen
\lugar{Municipio de Colón, Querétaro}                        % Lugar
