...
\begin{center}
    ...
    \captionof{figure}{Símbolo característico RGB de OpenCV}\label{Fig9}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{Representación del espacio de color RGB}\label{Fig10}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{Representación del espacio de color HSI}\label{Fig10}
\end{center}
...
\begin{center}
    ...
    \captionof{figure}{ Ejemplo de formas básicas de elementos estructurantes planos}\label{Fig13}
\end{center}
